...
static void _wqsort(register int *base, register int lo, register int hi, QSORTPROC cmp)
{
   int   k;
   register int i, j, t;
   register int *p = &k;
...
static void _lqsort(register long *base, register int lo, register int hi, QSORTPROC cmp)
{
   long  k;
   register int i, j, t;
   register long *p = &k;
...
static void _nqsort(register char *base, register int lo, register int hi, register int size, QSORTPROC cmp)
{
   register int i, j;
...
void __CDECL qsort (void *base, size_t num, size_t size, QSORTPROC cmp)
{
   char  _qtemp[128];

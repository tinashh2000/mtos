...
intptr_t /*int*/ __cdecl execl(const char *, const char *, ...);
intptr_t /*int*/ __cdecl execle(const char *, const char *, ...);
intptr_t /*int*/ __cdecl execlp(const char *, const char *, ...);
intptr_t /*int*/ __cdecl execv(const char *, char * const *);
intptr_t /*int*/ __cdecl execve(const char *, char * const *, char * const *);
intptr_t /*int*/ __cdecl execvp(const char *, char * const *);
/* void _exit(int); */
/* int fchown(int, uid_t, gid_t); */
/* pid_t fork(void); */
/* long fpathconf(int, int); */
int __cdecl ftruncate(int, off_t);
char * __CDECL getcwd(char *path, size_t sz);
/* gid_t getegid(void); */
/* uid_t geteuid(void); */
/* gid_t getgid(void); */
